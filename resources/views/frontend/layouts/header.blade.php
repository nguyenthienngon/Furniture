            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <style>
                        .social-icons img {
                            width: 24px;
                            /* Giảm kích thước chiều rộng của biểu tượng */
                            height: 24px;
                            /* Giảm kích thước chiều cao của biểu tượng */
                        ...
                        .social-icons .social-icon {
                            ...
                            /* Hiển thị các biểu tượng theo hàng ngang */
                            margin-right: 10px;
                    ...
                    <!-- Thêm CSS để định dạng biểu tượng mạng xã hội -->
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><i class="ti-location-pin"></i> <a href="{{ route('order.track') }}">Trạng thái đơn
                                    hàng</a></li>
                                ...
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            ...
                                            <span
                                                class="total-amount">{{ number_format(Helper::totalWishlistPrice(), 0) }}
                                                đ</span>
                                        </div>
                                        ...
                                        @foreach (Helper::getAllProductFromCart() as $data)
                                            ...
                                            <li>
                                                <a href="{{ route('cart-delete', $data->id) }}" class="remove"
                                                    title="Xóa sản phẩm"><i class="fa fa-remove"></i></a>
                                                <a class="cart-img" href="#"><img src="{{ $photo[0] }}"
                                                        alt="{{ $photo[0] }}"></a>
                                                <div>
                                                    <h4><a href="{{ route('product-detail', $data->product['slug']) }}"
