...
//Địa chỉ
Route::get('/diachi', 'CartController@index')->name('diachi');
Route::get('/get-quan-huyen', 'CartController@getQuanHuyen')->name('getQuanHuyen');
Route::get('/get-phuong-xa', 'CartController@getPhuongXa')->name('getPhuongXa');
