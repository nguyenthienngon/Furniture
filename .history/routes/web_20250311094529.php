...
Route::get('password/resets', 'FrontendController@showLinkRequestForm')->name('password.request');
Route::post('password/email', 'FrontendController@sendResetLinkEmail')->name('password.email');
Route::get('password/reset/{token}', 'FrontendController@showResetForm')->name('password.reset');
...
Route::get('/vnpay/payment', 'OrderController@vnpayPayment')->name('vnpay.payment');
// routes/web.php


Route::post('/vnpay-payment', 'VNPayController@createPayment')->name('vnpay.payment');
...
Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Report
    Route::resource('report', 'BrandController');
    // Order
    ...
    Route::get('/export-users', 'AdminController@exportUsers')->name('export.users');
    Route::get('/monthly-stats', 'AdminController@getMonthlyStats')->name('product.order.monthlyStats');
    Route::post('/payment/notify', 'OrderController@moMoIPN')->name('payment.notify');
...
//Địa chỉ
Route::get('/diachi', 'DiaChiController@index')->name('diachi');
Route::get('/get-quan-huyen', 'DiaChiController@getQuanHuyen')->name('getQuanHuyen');
Route::get('/get-phuong-xa', 'DiaChiController@getPhuongXa')->name('getPhuongXa');
