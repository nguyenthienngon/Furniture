...
<head>
    ...
    <style>
        body {
            ...
            font-size: 12px;
            margin: 0;
            /* Ensure no default body margin affects spacing */
        }
        ...
        .signatures {
            position: relative;
            /* Added to support absolute positioning of .signature-seller */
            display: flex;
            justify-content: space-between;
            margin-top: 5px;
        ...
        .signature-seller {
            ...
            width: 40%;
            padding-right: 0;
            /* Ensure it’s flush with the right */
        }

        .signature-date {
            border: 1px solid #000;
            /* Add a frame around the date */
            padding: 2px 5px;
            /* Add some padding inside the frame */
            display: inline-block;
            /* Ensure the frame fits the text */
            margin-top: 5px;
        ...
        <div class="container invoice-box">
            ...
            <div class="signatures">
                ...
                <div class="signature-seller">
                    ...
                    <p>(Ký, ghi rõ họ tên)</p>
                    <p>Ký bởi TEST</p>
                    <div class="signature-date">Ký ngày {{ $order->created_at->format('d-m-Y') }}</div>
                    <!-- Dynamic date with frame -->
                </div>
            </div>
        </div>
    @else
