...
<head>
    ...
    <style>
        ...
        .signature-seller {
            ...
            width: 40%;
            padding-right: 0;
            /* Remove padding to make it flush with the right edge */
        }

        /* Removed text-align: right and padding-right: 0 from buyer-info to revert to default alignment */
        .buyer-info {
            /* Default alignment (left) will apply */
        }
    </style>
</head>
