...
<head>
    ...
    <style>
        ...
        .invoice-title-sub {
            ...
            text-align: center;
            margin-top: -8px;
            /* Further reduced to minimize space */
            margin-bottom: 0;
            line-height: 1;
        }
        ...
        <div class="container invoice-box">
            ...
            <div class="invoice-header">
                ...
                <div>
                    ...
                    <p class="invoice-title-sub">Hóa đơn điện tử bán hàng</p>
                </div>
            ...
            <div class="signatures">
                <div class="signature-buyer">
                    ...
                    <br>
                    <br>
                    <p>Ký bởi: {{ $order->last_name }} {{ $order->first_name }}</p>
                </div>
                <div class="signature-seller">
                    ...
                    <div class="signature-stamp">
                        ...
                        <br>
                        Ký ngày: {{ $order->created_at->format('d/m/Y') }}
                    </div>
                </div>
            </div>
        </div>
