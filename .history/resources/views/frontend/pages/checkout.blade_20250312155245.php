...
<section class="shop checkout section">
    ...
    <div class="col-lg-4 col-md-4 col-12">
        <div class="form-group">
            <select class="form-select" id="province" name="province" onchange="handleProvinceChange(this)">
...
<style>
    ...
    select option {
        font-size: 0.8rem; /* Adjust this value to make the text smaller or bigger */
    }
