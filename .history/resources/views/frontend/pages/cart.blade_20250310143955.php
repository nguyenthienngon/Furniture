...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Ngăn chặn việc form bị submit khi nhấn Enter trong input số lượng
            $(".input-number").on("keydown", function(e) {
                if (e.key === "Enter") {
                    e.preventDefault(); // Ngăn chặn việc gửi form tự động
                    $(this).trigger("blur"); // Giả lập sự kiện "blur" để cập nhật giá trị
                }
            });
