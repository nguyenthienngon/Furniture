...
function handleProvinceChange(selectElement) {
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // Dữ liệu từ Laravel (truyền xuống JavaScript)
    ...
    window.handleProvinceChange = function(selectElement) {
        ...
        alert("Bạn đã chọn tỉnh/thành phố: " + provinceCode);
        console.log("Selected Province:", provinceCode);

        // Reset danh sách huyện/quận & xã/phường
