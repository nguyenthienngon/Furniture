        ...
        $(document).ready(function() {
            ...
            function loadProvinces() {
                ...
                addressData.forEach(function(province) {
                    provinceSelect.append(`<option value="${province.Code}">${province.FullName}</option>`);
                });
            }
            ...
            $('#province').on('change', function() {
                ...
                let selectedProvince = addressData.find(p => p.Code === provinceCode);
                loadDistricts(selectedProvince ? selectedProvince.Districts : []);
            });
            ...
            function loadDistricts(districts) {
                ...
                $('#ward').empty().append('<option value="">Chọn Phường/Xã</option>'); // Reset phường/xã
            ...
            $('#district').on('change', function() {
                ...
                let selectedProvince = addressData.find(p => p.Code === provinceCode);
                let selectedDistrict = selectedProvince ? selectedProvince.Districts.find(d => d.Code ===
                    districtCode) : null;
                loadWards(selectedDistrict ? selectedDistrict.Wards : []);
            });

            // Hiển thị danh sách phường/xã
            function loadWards(wards) {
                let wardSelect = $('#ward');
