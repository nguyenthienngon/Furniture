...
@push('scripts')
        ...
        $(document).ready(function() {
            ...
            $('form').on('submit', function(event) {
                ...
                if ($('input[name="payment_method"]:checked').length === 0) {
                    ...
                    // Thêm thông báo lỗi ngay dưới danh sách thanh toán
                    $('.checkbox').append(`
    ...
    `);
            ...
            $(document).on('click', '.nice-select .list li', function() {
                let value = $(this).data('value'); // Lấy giá trị đã chọn

                if (value !== "0" && value !== "" && value !== null) {
                    $('#shippingSelect').removeClass('is-invalid'); // Xóa lỗi nếu hợp lệ
                    $('#shippingSelect').siblings('.error-message').remove();
                }
            });
