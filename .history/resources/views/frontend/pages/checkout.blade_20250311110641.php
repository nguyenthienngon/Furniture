...
@section('main-content')
    ...
    <script>
        $("#province").change(function() {
            let provinceCode = $(this).val().toString(); // Đảm bảo kiểu dữ liệu là chuỗi
            let selectedProvince = allProvinces.find(p => p.Code.toString() === provinceCode);

            console.log("Selected Province: ", selectedProvince); // Kiểm tra dữ liệu tỉnh
            console.log("Districts: ", selectedProvince?.District || "Không có dữ liệu huyện");

            let districtSelect = $("#district"); // Lấy phần tử dropdown huyện
            districtSelect.empty().append(
            '<option value="">Chọn huyện</option>'); // Xóa dữ liệu cũ và thêm tùy chọn mặc định
