    ...
    <script>
        $(document).ready(function() {
                    ...
                    $('form').on('submit', function(event) {
                        ...
                        $('.error-message, .payment-error-message').remove();
                        ...
                        function showError(element, message) {
                            ...
                            $(element).after(`
            <span class="error-message" style="color: red; display: flex; align-items: center; gap: 5px; margin-top: 5px;">
        ...
        `);
                        ...
                        if ($('input[name="payment_method"]:checked').length === 0) {
                            ...
                            $('.checkbox').append(`
            <div class="payment-error-message" style="color: red; display: flex; align-items: center; gap: 5px; margin-top: 5px;">
                <i class="fa fa-exclamation-circle" aria-hidden="true"></i> Vui lòng chọn phương thức thanh toán.
            </div>
        `);
                            hasError = true;
                        }
                        ...
                        if (!selectedShipping || selectedShipping === "0") {
                            showError('select[name="shipping"]', 'Vui lòng chọn phương thức giao hàng.');
                        }
                    ...
                    // Xóa thông báo lỗi ngay khi người dùng chọn lại phương thức thanh toán
                    $('input[name="payment_method"]').on('change', function() {
                        $('.payment-error-message').remove();
                    });

                    // Xóa thông báo lỗi ngay khi người dùng chọn lại phương thức giao hàng
                    $('select[name="shipping"]').on('change', function() {
