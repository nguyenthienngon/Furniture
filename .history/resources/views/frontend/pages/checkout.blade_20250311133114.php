                                    ...
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        function updateDistricts(provinceCode) {
                                            fetch(`/api/districts/${provinceCode}`)
                                                ...
                                                .then(districts => {
                                                    districtSelect.innerHTML = '<option value="">Chọn huyện</option>'; // Xóa nội dung cũ
                                        ...
                                        function updateWards(provinceCode, districtCode) {
                                            fetch(`/api/wards/${provinceCode}/${districtCode}`)
                                                .then(response => {
                                                    if (!response.ok) {
                                                        throw new Error('Network response was not ok');
                                                    }
                                                ...
                                                .then(wards => {
                                                    wardSelect.innerHTML = '<option value="">Chọn xã</option>'; // Xóa nội dung cũ
                                                    wards.forEach(ward => {
                                                        const option = document.createElement("option");
