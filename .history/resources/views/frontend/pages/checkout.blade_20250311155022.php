...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const allDistrictOptions = Array.from(document.querySelectorAll(
            '#district option[data-province-code]'));
            const allWardOptions = Array.from(document.querySelectorAll('#ward option[data-district-code]'));
