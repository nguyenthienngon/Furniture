                    ...
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    <label for="tinh_id">Tỉnh/Thành phố:</label>
                                    <select id="tinh_id" name="tinh_id">
                                        <option value="">Chọn tỉnh/thành phố</option>
                                        @foreach ($tinhThanh as $tinhId => $tenTinh)
                                            <option value="{{ $tinhId }}">{{ $tenTinh }}</option>
                                        @endforeach
                                    </select>
                                </div>

                                <div>
                                    <label for="quan_id">Quận/Huyện:</label>
                                    <select id="quan_id" name="quan_id">
                                        <option value="">Chọn quận/huyện</option>
                                    </select>
                                </div>

                                <div>
                                    <label for="xa_id">Phường/Xã:</label>
                                    <select id="xa_id" name="xa_id">
                ...
                if (tinhId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#quan_id').empty();
                            $('#quan_id').append('<option value="">Chọn quận/huyện</option>');
                            $.each(data, function(key, value) {
                                $('#quan_id').append('<option value="' + key + '">' +
                                    value + '</option>');
                            });
                            $('#xa_id').empty(); // Clear phường/xã khi chọn tỉnh mới
                            $('#xa_id').append('<option value="">Chọn phường/xã</option>');
                        }
                    });
                } else {
                    $('#quan_id').empty();
