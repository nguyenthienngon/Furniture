    ...
    <script>
        $(document).ready(function() {
            $('#shippingSelect').on('change', function() {
                ...
                const price = selectedOption.data('price'); // Lấy phí giao hàng

                // Cập nhật giá trị của trường địa chỉ 1
                const address1Value = `${type}: Phí giao hàng ${new Intl.NumberFormat().format(price)}đ`;
