                        ...
                        <div class="checkout-form">
                            ...
                            <div class="row">
                                ...
                                <script>
                                    ...
                                    let locations = []; // Biến để lưu dữ liệu JSON
                                    ...
                                    // Tải dữ liệu từ file address.json khi trang được tải
                                    window.onload = function() {
                                        fetch('public/js/address.json')
                                            ...
                                            .then(data => {
                                                locations = data; // Gán dữ liệu từ file JSON vào biến locations
                                                loadProvinces(); // Tải danh sách tỉnh sau khi có dữ liệu
                                            })
                                            .catch(error => {
                                                console.error('Lỗi khi tải dữ liệu:', error);
                                                alert('Có lỗi xảy ra khi tải dữ liệu địa chỉ. Vui lòng thử lại sau.');
                                            });
                                    };
                                </script>
