                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    $(document).on("change", "#province", function() {
                                        ...
                                        console.log("Danh sách huyện sau khi cập nhật:", districtSelect.html());

                                        // Nếu có huyện đầu tiên, tự động load danh sách xã của huyện đó
                                        if (districts.length > 0) {
                                            let firstDistrict = districts[0];
                                            districtSelect.val(firstDistrict.Code).trigger(
                                                "change"); // Chọn huyện đầu tiên và kích hoạt change
                                        }
                                    });
                                    ...
                                    $(document).on("change", "#district", function() {
                                        ...
                                        console.log("Danh sách xã:", wards);

                                        let wardSelect = $("#ward");
                                        wardSelect.empty().append('<option value="">Chọn xã</option>');

                                        wards.forEach(ward => {
                                            wardSelect.append(`<option value="${ward.Code}">${ward.FullName}</option>`);
                                        });

                                        console.log("Danh sách xã sau khi cập nhật:", wardSelect.html());
                                    });
                                });
                            </script>
