...
window.handleProvinceChange = function (selectElement) {
    ...
    if (filteredDistricts.length > 0) {
        ...
        districtSelect.disabled = false; // Bật lại dropdown huyện  
    } else {
        console.warn("Không tìm thấy huyện nào cho tỉnh này!");
    }

    // Kiểm tra lại trạng thái của districtSelect sau khi mở
    setTimeout(() => {
        console.log("districtSelect.disabled sau khi mở:", districtSelect.disabled);
    }, 500);
};
