...
function handleProvinceChange(selectElement) {
    ...
    if (provinceCode) {
        ...
        console.log("Sự kiện onchange: Giá trị tỉnh/thành phố đã thay đổi:", provinceCode);
    }
}

// Kiểm tra sự kiện trong Console
document.addEventListener("DOMContentLoaded", function() {
    const provinceSelect = document.getElementById("province");
    
    provinceSelect.addEventListener("change", function() {
        console.log("Sự kiện change: Giá trị tỉnh/thành phố đã thay đổi:", this.value);
    });
});
