        ...
        $(document).ready(function() {
            ...
            $('#province').on('change', function() {
                ...
                if (province && addressData[province]) {
                    $.each(addressData[province], function(key, value) {
                        districtSelect.append(`<option value="${key}">${key}</option>`);
                    });
                }
                $('#ward').empty().append(
                '<option value="">Chọn Phường/Xã</option>'); // Reset danh sách phường/xã
            });
            ...
            $('#district').on('change', function() {
                ...
                if (province && district && addressData[province][district]) {
                    $.each(addressData[province][district], function(index, ward) {
