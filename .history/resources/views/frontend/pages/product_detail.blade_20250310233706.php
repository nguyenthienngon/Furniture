                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-des">
                                ...
                                <div class="product-buy">
                                    <<div class="quantity">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="slug" id="product-slug"
                                                value="{{ $product_detail->slug }}">
                                            <input type="text" name="quant" class="input-number" id="quantity"
                                                value="1" data-min="1" data-max="1000000">
                                ...
                                <div class="add-to-cart mt-4">
                                    <button type="button" class="btn add-to-cart-btn">Thêm vào giỏ hàng</button>
                                                ...
                                                <div class="ratting-main">
                                                    <div class="avg-ratting ">
                                                        @if ($product_detail->getReview && $product_detail->getReview->count() > 0)
                                                            <h4>
                                                                {{ number_format($product_detail->getReview->avg('rate'), 1) }}
                                                                <span class="stars">
                                                                    @for ($i = 1; $i <= 5; $i++)
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        ...
                                        <div class="product-action-2">
                                            <button class="add-to-cart-btn" data-slug="{{ $product_detail->slug }}">
                                                Thêm vào giỏ hàng
                                            </button>
                                        </div>
