...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            let addressData = {}; // Biến lưu dữ liệu JSON

            // Đọc dữ liệu từ file address.json
            $.getJSON("js/address.json", function(data) {
                addressData = data.province; // Lưu dữ liệu tỉnh/thành phố
            ...
            $("#province").change(function() {
                ...
                let selectedProvince = addressData.find(province => province.id == provinceId);
                if (selectedProvince) {
            ...
            $("#district").change(function() {
                ...
                let selectedProvince = addressData.find(province => province.districts.some(d => d.id ==
                    districtId));
                if (selectedProvince) {
                    let selectedDistrict = selectedProvince.districts.find(d => d.id == districtId);
                    if (selectedDistrict) {
