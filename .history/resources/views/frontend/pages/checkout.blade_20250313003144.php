                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        <form-group>
                                            ...
                                            <!-- Đặt lỗi ngay dưới phương thức thanh toán MoMo -->
            ...
            $('form').on('submit', function(event) {
                ...
                if ($('input[name="first_name"]').val().trim() === "") {
                    ...
                    $('input[name="first_name"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng nhập Họ.</span>');
                }
                ...
                if ($('input[name="last_name"]').val().trim() === "") {
                    ...
                    $('input[name="last_name"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng nhập Tên.</span>');
                }
                ...
                if ($('input[name="email"]').val().trim() === "") {
                    ...
                    $('input[name="email"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng nhập Email.</span>');
                }
                ...
                if ($('input[name="phone"]').val().trim() === "") {
                    ...
                    $('input[name="phone"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng nhập Số điện thoại.</span>'
                    );
                }
                ...
                if ($('input[name="address1"]').val().trim() === "") {
                    ...
                    $('input[name="address1"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng nhập Địa chỉ.</span>');
                }
                ...
                if ($('input[name="payment_method"]:checked').length === 0) {
                    ...
                    $('input[name="payment_method"]').last().after(
                        '<span class="error-message" style="color: red;">Vui lòng chọn phương thức thanh toán.</span>'
                    );
                }
                ...
                if (!selectedShipping || selectedShipping === "0") {
                    hasError = true;
                    $('select[name="shipping"]').addClass('is-invalid');
                    $('select[name="shipping"]').after(
                        '<span class="error-message" style="color: red;">Vui lòng chọn phương thức giao hàng.</span>'
                    );
                }
