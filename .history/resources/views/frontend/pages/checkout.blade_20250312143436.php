...
<script>
    ...
    // Bắt sự kiện input để kiểm tra giá trị thay đổi
    provinceSelect.addEventListener("input", function() {
        console.log("Sự kiện input: Giá trị tỉnh/thành phố đã thay đổi:", this.value);
        alert("Bạn đã chọn tỉnh/thành phố: " + this.value);
    });
});
