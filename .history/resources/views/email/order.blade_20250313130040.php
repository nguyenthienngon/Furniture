...
<body>
    <div class="container">
        ...
        <p>Nếu bạn có bất kỳ câu hỏi nào, đừng ngần ngại liên hệ với chúng tôi qua email <a
                href="mailto:support@artisan.com">support@cuahang.com</a> hoặc số hotline: 0123 456 789.</p>
        <p>Chúc bạn một ngày tốt lành!</p>

        <div class="footer">
            <p>Trân trọng,<br>Đội ngũ Cửa hàng của chúng tôi<br>
                <a href="#">www.aritsan.com</a> | <a href="#">Theo dõi chúng tôi trên mạng xã hội</a>
            </p>
        </div>
    </div>
</body>
