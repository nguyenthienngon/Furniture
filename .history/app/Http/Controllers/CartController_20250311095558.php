...
class CartController extends Controller
{
    ...
    public function getQuanHuyen(Request $request)
    {
        ...
        if (is_array($data)) {
            foreach ($data as $tinh) {
                if (isset($tinh['tinh_id']) && $tinh['tinh_id'] == $tinhId && isset($tinh['quan']) && is_array($tinh['quan'])) {
                    foreach ($tinh['quan'] as $quan) {
                        if (isset($quan['quan_id']) && isset($quan['name'])) {
    ...
    public function getPhuongXa(Request $request)
    {
        ...
        if (is_array($data)) {
            foreach ($data as $tinh) {
                if (isset($tinh['quan']) && is_array($tinh['quan'])) {
                    foreach ($tinh['quan'] as $quan) {
                        if (isset($quan['quan_id']) && $quan['quan_id'] == $quanId && isset($quan['xa']) && is_array($quan['xa'])) {
                            foreach ($quan['xa'] as $xa) {
                                if (isset($xa['xa_id']) && isset($xa['name'])) {
