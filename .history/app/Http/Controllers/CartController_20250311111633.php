...
class CartController extends Controller
{
    ...
    public function checkout()
    {
        ...
        if (!$provinces || !is_array($provinces)) {
            abort(500, "Dữ liệu JSON không hợp lệ.");
        }

        // Tìm tỉnh có Code = "01"
        $selectedProvince = collect($provinces)->firstWhere('Code', '01');
        ...
        // Debug dữ liệu
        dd([
            'Tỉnh 01' => $selectedProvince['FullName'] ?? 'Không tìm thấy',
            'Danh sách huyện' => $districts
        ]);
