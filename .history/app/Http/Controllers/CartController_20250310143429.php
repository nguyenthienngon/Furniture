...
class CartController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        // Kiểm tra số lượng sản phẩm trong giỏ hàng so với tồn kho
        foreach ($cartItems as $item) {
            ...
            // Kiểm tra giá trị thực tế của quantity và stock
            dump([
            ...
            if ($item->quantity > $product->stock) {
                $errors[] = "Sản phẩm '{$product->title}' chỉ còn {$product->stock} sản phẩm trong kho.";
            }
        }
